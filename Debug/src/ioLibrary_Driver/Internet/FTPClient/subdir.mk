...
C_SRCS += \
../src/ioLibrary_Driver/Internet/FTPClient/ftpc.c 

OBJS += \
./src/ioLibrary_Driver/Internet/FTPClient/ftpc.o 

C_DEPS += \
./src/ioLibrary_Driver/Internet/FTPClient/ftpc.d 


# Each subdirectory must supply rules for building sources it contributes
src/ioLibrary_Driver/Internet/FTPClient/%.o: ../src/ioLibrary_Driver/Internet/FTPClient/%.c
	@echo 'Building file: $<'
