...
C_SRCS += \
../src/ioLibrary_Driver/Internet/FTPServer/ftpd.c 

OBJS += \
./src/ioLibrary_Driver/Internet/FTPServer/ftpd.o 

C_DEPS += \
./src/ioLibrary_Driver/Internet/FTPServer/ftpd.d 


# Each subdirectory must supply rules for building sources it contributes
src/ioLibrary_Driver/Internet/FTPServer/%.o: ../src/ioLibrary_Driver/Internet/FTPServer/%.c
	@echo 'Building file: $<'
