...
C_SRCS += \
../src/ioLibrary_Driver/Internet/DHCP/dhcp.c 

OBJS += \
./src/ioLibrary_Driver/Internet/DHCP/dhcp.o 

C_DEPS += \
./src/ioLibrary_Driver/Internet/DHCP/dhcp.d 


# Each subdirectory must supply rules for building sources it contributes
src/ioLibrary_Driver/Internet/DHCP/%.o: ../src/ioLibrary_Driver/Internet/DHCP/%.c
	@echo 'Building file: $<'
